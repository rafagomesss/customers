    ...
    <div class="col-md-6 col-md-8">
        <form id ="form<?= !empty($customer['id']) ? 'Update' : 'Register';?>Customer" action="/customer/<?= !empty($customer['id']) ? 'update' : 'register';?>Customer" method="POST" class="needs-validation">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input id="customerName" name="customerName" type="text" class="form-control required" value="<?= $customer['name'] ?? null;?>" required/>
                </div>
            </div>
            <div class="row mb-3">
                <label for="customerCPF" class="col-sm-2 col-form-label">CPF: </label>
                <div class="col-sm-4">
                    <input id="customerCPF" name="customerCPF" type="text" class="form-control maskCPF" value="<?= $customer['cpf'] ?? null;?>" />
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-4">
                    <input id="customerCep" name="customerCep" type="text" class="form-control" value="<?= $customer['cep'] ?? null;?>" />
                </div>
            </div>
            <div class="row mb-3">
                <label for="customerAddress" class="col-sm-2 col-form-label">Endereço: </label>
                <div class="col-sm-4">
                    <input id="customerAddress" name="customerAddress" type="text" class="form-control" value="<?= $customer['address'] ?? null;?>" />
                </div>
                <label for="customerCep" class="col-sm-2 col-form-label">Bairro: </label>
                <div class="col-sm-4">
                    <input id="customerNbh" name="customerNbh" type="text" class="form-control" value="<?= $customer['neighborhood'] ?? null;?>" />
                </div>
            </div>
            <div class="row mb-3">
                <label for="customerNumber" class="col-sm-2 col-form-label">Número: </label>
                <div class="col-sm-2">
                    <input id="customerNumber" name="customerNumber" class="form-control" type="text" value="<?= $customer['number'] ?? null;?>" />
                </div>
                <label for="customerComplement" class="col-sm-2 col-form-label">Complemento: </label>
                <div class="col-sm-6">
                    <input id="customerComplement" name="customerComplement" type="text" class="form-control" value="<?= $customer['complement'] ?? null;?>" />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input id="customerCity" name="customerCity" type="text" class="form-control" value="<?= $customer['city'] ?? null;?>"/>
                </div>
            </div>
